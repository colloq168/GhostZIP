...
mkdir -p /var/www
cd /var/www/
curl -L -O https://raw.githubusercontent.com/colloq168/GhostZIP/master/Ghost-0.6.3-zh-full.zip
unzip -d ghost Ghost-0.6.3-zh-full.zip
rm Ghost-0.6.3-zh-full.zip
cd ghost/
